...
{
    public class BlobHelper : IBlobHelper// herencia e implementacion de la intefaz
    {
        private readonly CloudBlobClient _blobClient;// instriccion para el manejo del blob
